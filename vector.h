...
#define DECL_VECTOR_AT(T) T VECTOR_METHOD(T, at)(VECTOR_REF(T) self, const size_t idx)
...
#define DECL_VECTOR_AT_NOCHECK(T) T VECTOR_METHOD(T, at_nocheck)(VECTOR_REF(T) self, const size_t idx)
...
#define DECL_VECTOR_FRONT(T) T VECTOR_METHOD(T, front)(VECTOR_REF(T) self)
#define DEFINE_VECTOR_FRONT(T)                          \
  DECL_VECTOR_FRONT(T) {                                \
    return VECTOR_METHOD(T, at_nocheck)(self, 0);               \
  }

#define DECL_VECTOR_BACK(T) T VECTOR_METHOD(T, back)(VECTOR_REF(T) self)
...
#define DECL_VECTOR_SIZE(T) size_t VECTOR_METHOD(T, size)(VECTOR_REF(T) self)
#define DEFINE_VECTOR_SIZE(T)                 \
  DECL_VECTOR_SIZE(T) {                       \
    return self->size;                        \
  }

#define DECL_VECTOR_CAPACITY(T) size_t VECTOR_METHOD(T, capacity)(VECTOR_REF(T) self)
#define DEFINE_VECTOR_CAPACITY(T)                   \
  DECL_VECTOR_CAPACITY(T) {                         \
    return self->capacity;                          \
  }

#define DECL_VECTOR_EMPTY(T) bool VECTOR_METHOD(T, empty)(VECTOR_REF(T) self)
